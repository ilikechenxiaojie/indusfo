  ...
  <div class="informs">
    <el-card class="informs-card">
      ...
      <span style="float: left; margin-bottom: 1rem; width: 66%;" class="btn-group">
        <el-button size="small" @click="showrawMaterialDialog">新增</el-button>
        ...
        <el-button size="small" style="margin-left: 3%; float:left" type="primary">复制产品工艺</el-button>
      </span>
      ...
      <el-table :data="informs" style="width: 100%;" v-loading="loading" element-loading-text="给我一点时间" border @selection-change="handleSelectionChange" :header-cell-style="headerStyle">
        ...
        <el-table-column prop="singleNum" label="供应商编码" align="center"></el-table-column>
        <el-table-column prop="material" label="供应商名称" align="center"></el-table-column>
        <el-table-column prop="type" label="地址" align="center"></el-table-column>
        <el-table-column prop="prod" label="联系方式" align="center"></el-table-column>
        <el-table-column prop="prod" label="企业规模" align="center"></el-table-column>
        <el-table-column prop="prod" label="企业性质" align="center"></el-table-column>
        <el-table-column prop="prod" label="联系人" align="center"></el-table-column>
        <el-table-column prop="prod" label="环评情况" align="center"></el-table-column>
        <el-table-column prop="prod" label="安评情况" align="center"></el-table-column>
        <el-table-column prop="prod" label="评级" align="center"></el-table-column>
        ...
        <el-table-column prop="planEndTime" label="操作" align="center">
          <template slot-scope="scope">
            ...
            <span><i class="el-icon-edit-outline" @click.prevent="detailHandle(scope.row)"></i></span>
    ...
    <update-table-for-raw-material :data="rawMaterialTemp" :visible="rawMaterialVisible" @cancel="rawMaterialDialog" @confirm="rawMaterialUpdate" />
  </div>
</template>
<script>
import { fetchInformByPage } from '@/api/inform/admin'
import SearchButton from '@/components/Buttons/SearchButton'
import UpdateTableForRawMaterial from '@/components/Dialog/UpdateTableForRawMaterial'
...
export default {
  ...
  methods: {
    ...
    // 子组件传数据
    showrawMaterialDialog() {
      this.rawMaterialTemp = this.informs
      this.rawMaterialDialog()
    },
    // 子组件显示
    rawMaterialDialog() {
      console.log(this.rawMaterialVisible)
      this.rawMaterialVisible = !this.rawMaterialVisible
    },
    // 子组件更新数据按钮
    rawMaterialUpdate() {
      this.rawMaterialDialog()
