<template>
  <div class="informs">
    ...
    <update-table-for-supplier :visible="supplierVisible" @cancel="supplierDialog" @confirm="supplierUpdate" />
  </div>
</template>
<script>
import { fetchInformByPage } from '@/api/inform/admin'
import SearchButton from '@/components/Buttons/SearchButton'
import UpdateTableForSupplier from '@/components/Dialog/UpdateTableForSupplier'
...
export default {
  ...
  methods: {
    ...
    // 子组件传数据
    showsupplierDialog() {
      this.supplierTemp = this.informs
      this.supplierDialog()
    },
    // 子组件显示
    supplierDialog() {
      console.log(this.supplierVisible)
